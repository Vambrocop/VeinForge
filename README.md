...
| [retrain](docs/retrain.md) | 如何(再次)训练 DL 模型 |
| [train_strong_base.ipynb](notebooks/train_strong_base.ipynb) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Vambrocop/VeinForge/blob/main/notebooks/train_strong_base.ipynb) | **Colab 一键**:免费 GPU + 全部公共数据 → 强通用脉底座 |
